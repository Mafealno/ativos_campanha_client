    ...
    return (
      <>
        <div id="container-menu-aplicativo">
            ...
            <div id="janela-suspensa" className={ props.showJanelaSuspensa ? "mostrar" : "esconder"}>
                <Link to="/dashboard/menu"><div><i className="fa fa-list mr-3"></i>Dashboard</div></Link>
                <div onClick={() => setShowModalAlterarSenha(true)}><i className="fa fa-gears mr-3"></i>Alterar minha senha</div>
...
const mapDispatchToProps = (dispatch) => ({
  setShowJanelaSuspensa : (showJanelaSuspensa) => dispatch(menuAplicativoActions.setShowJanelaSuspensa(showJanelaSuspensa)),
});
